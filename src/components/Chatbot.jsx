  ...
  return (
    <div className="fixed bottom-20 md:bottom-10 left-0 w-full z-5000 pointer-events-none">
      <div className="container flex justify-end items-center relative">
        ...
        {/* Popup Chat Window */}
        {/* {isOpen && ( */}
          <div className={`absolute bottom-20 ml-4 right-6 z-30 bg-transparent shadow-xl rounded-2xl overflow-hidden max-w-90 p-0 text-dark pointer-events-auto transform transition-all duration-400 ease-in-out ${
